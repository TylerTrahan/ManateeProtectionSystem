 ...
 * Description : Prototype definitions - include file.
 * Updated     : 04-Jun-2015
 *
...
Terr EXPORT_FN TMG_convert_to_RGB24(Thandle, Thandle, ui16);        /* non-doc */
...
Terr EXPORT_FN TMG_convert_to_BGRX32(Thandle, Thandle, ui16);       /* non-doc */
...
Terr EXPORT_FN TMG_convert_to_BGR24(Thandle, Thandle, ui16);        /* non-doc */
...
Terr EXPORT_FN TMG_convert_to_Y8(Thandle, Thandle, ui16);           /* non-doc */
Terr EXPORT_FN TMG_convert_to_Y16(Thandle, Thandle, ui16);          /* non-doc */
...
Terr EXPORT_FN TMG_YUV422_to_BGRX32(Thandle, Thandle, ui16);       /* non-doc */
...
Terr EXPORT_FN TMG_YUV422_to_Y8(Thandle, Thandle, ui16);           /* non-doc */
...
tmg_crop.c(ForBrief)
 */
Terr EXPORT_FN TMG_IP_crop(Thandle, Thandle, i16[], ui16);
...
/* -------------------------------- */
Terr     EXPORT_FN TMG_display_create(void);
Terr     EXPORT_FN TMG_display_destroy(Thandle);
 ...
 */
/* User functions: */
Terr EXPORT_FN TMG_display_init(Tdisplay_handle, HWND);
...
Terr     EXPORT_FN     TMG_image_copy(Thandle, Thandle);
Terr     EXPORT_FN     TMG_image_copy_parameters(Thandle, Thandle);
Terr     EXPORT_FN     TMG_image_copy_parameters_raw(Thandle, Thandle);
Thandle  EXPORT_FN     TMG_image_create(void);
Terr     EXPORT_FN     TMG_image_destroy(Thandle);
Terr     EXPORT_FN     TMG_ImageUnlockAndDestroy( Thandle hImage);
Terr     EXPORT_FN     TMG_image_free_data(Thandle);
ui32     EXPORT_FN     TMG_image_get_parameter(Thandle, ui16);
void     EXPORT_FN_PTR TMG_image_get_ptr(Thandle, ui16);
Terr     EXPORT_FN     TMG_image_get_flags(Thandle, ui32);
char     EXPORT_FN_PTR TMG_image_get_infilename(Thandle);
char     EXPORT_FN_PTR TMG_image_get_outfilename(Thandle);
Terr     EXPORT_FN     TMG_image_malloc_a_strip(Thandle);
...
TMG_scl.c(ForBrief)
 */
Terr EXPORT_FN TMG_IP_subsample(Thandle, Thandle, ui16, ui16);
...
Terr EXPORT_FN TMG_IP_mirror(Thandle hInImage, Thandle hOutImage, i16 *roi, ui16 TMG_action);
