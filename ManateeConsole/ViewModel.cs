...
namespace ManateeConsole
{
    ...
    public class ViewModel : INotifyPropertyChanged
    {
        ...
        private float _startRange_s1 = 0;
        private float _stopRange_s1 = 8;
        private float _startRange_s2 = 0;
        private float _stopRange_s2 = 8;
        ...
        //--PanTilt Variables--//
        private string _serialPort_pt1 = null;
        private string _partner_pt1 = null;
        private float _panHome_pt1 = 0;
        private float _tiltHome_pt1 = 0;
        private string _serialPort_pt2 = null;
        private string _partner_pt2 = null;
        private float _panHome_pt2 = 0;
        private float _tiltHome_pt2 = 0;
        //--PLC Controller Variables--//
        private bool _isPLC_connected = false;
        private ArduinoDriver.ArduinoDriver _driver = null;
        ...
        {
            get { return (_isPLC_connected != null) ? _isPLC_connected : false; }
            set
            {
                if (value != this._isPLC_connected)
                {
                    this._isPLC_connected = value;
                    OnPropertyChanged("isPLC_Connected");
                }
            }
        }
